...
ace.define("ace/mode/gobstones_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function (require, exports, module) {
  ...
  var GobstonesHighlightRules = function GobstonesHighlightRules() {
    var keywords = "program|procedure|function|interactive|if|then|else|switch|repeat|while|foreach|in|not|div|mod|Skip|return";
    var buildinConstants = "False|True";
    var langClasses = "Poner|Sacar|Mover|IrAlBorde|VaciarTablero|" + "nroBolitas|hayBolitas|puedeMover|siguiente|previo|opuesto|minBool|maxBool|" + "minDir|maxDir|minColor|maxColor";
    var supportType = "Verde|Rojo|Azul|Negro|Norte|Sur|Este|Oeste";
    var keywordMapper = this.createKeywordMapper({
      "keyword": keywords,
